...
class HTMLCalendar(Calendar):
    ...
    cssclasses = ["sun","mon", "tue", "wed", "thu", "fri", "sat"]
    ...
    def formatday(self, day, weekday):
        ...
        if day == 0:
            # day outside month
            return '<td class=" %s">&nbsp;</td>' % (self.cssclass_noday, weekday)
        else:
    ...
    def formatweekheader(self):
        ...
        return '<tr class="week" ">%s</tr><tr class="space">   </tr>' % s
    ...
    def formatmonthname(self, theyear, themonth, withyear=False):
        ...
        return '<tr><th colspan="7" class="%s"><span class="month">%s</span><span class = "year">%s</span></th></tr>' % (
            self.cssclass_month_head, s, theyear) 
